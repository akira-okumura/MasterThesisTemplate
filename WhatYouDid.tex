...
\begin{figure}
  \begin{minipage}[b]{.5\linewidth} % 図の最大幅は 1 行の幅の 0.5 倍
    \leftline{(a)}
    \centering
    \includegraphics[width=8cm]{fig/histogram.pdf} % これが大きすぎると図が重なる
  \end{minipage}% }の直後に%を置くことで、改行をさせない（図(b)を改行させない0）。
